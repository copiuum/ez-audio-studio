  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        studio: "bg-gradient-control text-foreground hover:bg-gradient-accent shadow-control transition-studio border border-border",
        play: "bg-gradient-highlight text-primary-foreground hover:shadow-glow transition-studio",
        control: "bg-gradient-panel text-foreground hover:bg-gradient-control border border-border shadow-panel transition-smooth",
      },
      size: {
